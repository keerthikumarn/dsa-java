...
public class CourseRegDemo {
	...
	public static void main(String[] args) {
		...
		Course course2 = courseRegistrationSystem.addCourse("CS201", "Data Structures and Algorithms", "John Smith",
				30);
		...
		courseRegistrationSystem.getAvailableCourses().forEach(c -> System.out.println("Available: " + c.getName()));
	}
}
