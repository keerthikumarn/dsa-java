...
public class LinkedInDemo {
	...
	public static void main(String[] args) {
		...
		// User registration
		User user1 = linkedInService.register("Keerthi Kumar N", "keerthikumar@no-reply.com", "test123");
		User user2 = linkedInService.register("Raghavendra Nayak", "raghav@no-reply.com", "test1234");
		...
		// Post a job listing
		JobPosting jobPosting1 = linkedInService.postJobListing("Software Developer", "Discord", "AI Engineer",
				"San Francisco");
		JobPosting jobPosting2 = linkedInService.postJobListing("Software Developer", "Airbnb", "Full Stack Developer",
				"Seattle");
		...
		// Send a message
		linkedInService.sendMessage(user1, user2, "Hi Raghav, hope you're doing well!");
