...
public class FoodDeliveryServiceDemo {
	...
	public static void main(String[] args) {
        ...
        // Register customers
        Customer customer1 = new Customer("C001", "Keerthi Kumar N", "keerthi@no-reply.com", "1234567890");
        Customer customer2 = new Customer("C002", "Chenna Reddy", "chenna@example.com", "9876543210");
        ...
        DeliveryAgent agent1 = new DeliveryAgent("D001", "Delivery Agent 1", "2121212121");
        DeliveryAgent agent2 = new DeliveryAgent("D002", "Delivery Agent 2", "4343434343");
